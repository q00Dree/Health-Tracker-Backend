...
{
    public class FallSensor : Sensor
    {
        public FallSensor(string deviceId, string sensorType) : base(deviceId, sensorType) { }
        public FallSensor() { }
        ...
        {
            //Example sensors_fall,postgre_id=1 currentValue=true 12121212112
            var influxPostData =
                $"sensors_{SensorType}," +
